...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('asignar_horario_conductor_vehiculo', function (Blueprint $table) {
            ...
            $table->foreignId("primer_conductor")->constrained("empleados");
            $table->foreignId("segundo_conductor")->constrained("empleados")->nullable();
            $table->foreignId("vehiculo")->constrained("vehiculos")->nullable();
            $table->timestamps();
        });
    }
