...
<div class="container-fluid py-4">
    <div class="d-flex flex-column flex-xl-row justify-content-between align-items-xl-center gap-3 mb-4">
        ...
        <form method="GET" action="{{ route('dashboard.admin') }}" class="row g-2">
            <div class="col-auto">
                <input type="date" name="desde" value="{{ request('desde', now()->startOfMonth()->format('Y-m-d')) }}" class="form-control">
            </div>
            <div class="col-auto">
                <input type="date" name="hasta" value="{{ request('hasta', now()->format('Y-m-d')) }}" class="form-control">
            </div>
            <div class="col-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-4">Sin datos disponibles</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="text-center text-muted py-5">No hay registros disponibles.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
