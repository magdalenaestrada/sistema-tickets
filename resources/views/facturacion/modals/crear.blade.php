...
<div class="modal fade" id="modalVentaRapida" tabindex="-1" aria-labelledby="modalVentaRapidaLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <form method="POST" action="{{ route('facturacion.pos.store') }}" class="modal-content border-0 rounded-4 shadow-lg">
            @csrf

            <!-- Header -->
            <div class="modal-header border-bottom-0 pb-0">
                <div class="d-flex align-items-center gap-2">
                    <button type="button" class="btn btn-sm btn-light border rounded-circle" data-bs-toggle="modal" data-bs-target="#modalOpcionesComprobante" title="Volver">
            ...
            <div class="modal-body p-4">
                ...
                <div class="card bg-light border-0 rounded-3 p-3 mb-3">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold text-secondary">Sucursal <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold text-secondary">Tipo documento <span class="text-danger">*</span></label>
                            <select id="tipo_documento_modal" name="tipo_documento_factura_id" class="form-select form-select-sm" required>
                        ...
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold text-secondary">Serie <span class="text-danger">*</span></label>
                            <input type="text" id="serie" class="form-control form-control-sm bg-white" readonly required>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 border-start border-primary border-3 shadow-sm rounded-3 p-3 mb-3">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label small fw-semibold text-secondary">Documento <span class="text-danger">*</span></label>
                            <div class="input-group input-group-sm">
                                <input type="text" id="doc_cliente" name="documento" class="form-control" placeholder="DNI o RUC" required>
                                <button type="button" id="btnBuscarCliente" class="btn btn-primary" onclick="buscarCliente()">
                        ...
                        <div class="col-md-4">
                            <label id="lblNombre" class="form-label small fw-semibold text-secondary">Nombres <span class="text-danger">*</span></label>
                            <input type="text" id="nombres" name="nombres" class="form-control form-control-sm" required>
                        </div>

                        <div class="col-md-4" id="divApellidos">
                            <label class="form-label small fw-semibold text-secondary">Apellidos <span class="text-danger">*</span></label>
                ...
                <div class="card border-0 shadow-sm rounded-3 p-3">
                    <h6 class="fw-bold text-dark mb-3 small"><i class="bi bi-box-seam me-1"></i> Detalle del Servicio</h6>
                    ...
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="descripcion" class="form-control form-control-sm" placeholder="Escribir descripción">
                        </div>
                        <div class="col-md-2">
                            <input type="number" step="0.01" id="unidad" class="form-control form-control-sm" placeholder="Unidades">
                        </div>
                        <div class="col-md-2">
                            <input type="number" step="0.01" id="precio" class="form-control form-control-sm" placeholder="Precio (incl. IGV)">
                        </div>
                        <div class="col-md-2">
                            <button type="button" class="btn btn-success btn-sm w-100 fw-bold" onclick="agregarItem()">
