...
<div class="modal fade" id="modalComprobanteExistente" tabindex="-1" aria-labelledby="modalComprobanteExistenteLabel"
    aria-hidden="true">
        ...
        <div class="modal-content border-0 rounded-4 p-3 shadow-lg">
            ...
            <div class="modal-body pt-2">
                ...
                <div class="mb-4">
                    ...
                    <label class="form-label small fw-semibold text-secondary">Buscar comprobante <span
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <input type="text" id="buscar_comprobante_input" class="form-control border-start-0"
                            placeholder="Ingrese serie y número o busque por cliente...">
                    ...
                    <!-- Aquí van los resultados de búsqueda, generados por JS -->
                    <div id="resultado_busqueda_comprobante"></div>

                    <!-- Aviso de anulación / NC, oculto hasta que se seleccione un comprobante -->
                    <div id="aviso_anulacion_origen" class="rounded-3 p-2 px-3 mb-2"
                        style="display:none; font-size:.78rem;"></div>
                ...
                <div class="mb-4">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-md-3">
                            <label class="form-label extra-small text-secondary fw-semibold"
                                style="font-size: 0.75rem;">Tipo de comprobante destino <span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label extra-small text-secondary fw-semibold"
                                style="font-size: 0.75rem;">Serie <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label extra-small text-secondary fw-semibold"
                                style="font-size: 0.75rem;">Número <span class="text-danger">*</span></label>
                    ...
                    <div class="bg-light bg-opacity-10 rounded-3 p-2.5 px-3 mb-3 d-flex align-items-center gap-2"
                        style="font-size: 0.75rem;">
                        <i class="bi bi-info-circle text-primary fs-6"></i>
                        <div>
                            <span class="text-dark d-block">Al emitir este comprobante, se generará una referencia al
                                documento original.</span>
                            <span class="text-secondary fw-semibold">No se modificará el comprobante de origen.</span>
                        </div>
                    </div>

                    <!-- Documento de referencia: ahora dinámico -->
                    <div class="border rounded-3 p-2.5 px-3 d-flex justify-content-between align-items-center">
                        <div class="small">
                            ...
                            <strong class="text-dark" id="texto_documento_referencia">Ninguno seleccionado</strong>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="bg-light bg-opacity-10 rounded-3 p-2.5 px-3 mb-3 d-flex align-items-center gap-2"
                        style="font-size: 0.75rem;">
                        <i class="bi bi-info-circle text-primary fs-6"></i>
                        <span class="text-secondary fw-semibold">Se mantendrán los productos / servicios del
                            comprobante de referencia.</span>
                    </div>

                    <div class="d-flex justify-content-end align-items-center gap-3">
                        <span class="text-muted small">Total a emitir</span>
                        <strong class="text-primary fs-4" id="total_a_emitir">S/ 0.00</strong>
                    </div>
                </div>
