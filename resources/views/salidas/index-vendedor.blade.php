@extends('layouts.app') @section('content')
    <div class="row g-3"> {{-- Columna Izquierda: Tabla y Gestión Principal --}} <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row g-2 mb-3">
                        ...
                        <div class="col-md-5 col-sm-6">
                            <div class="input-group"> <span class="input-group-text bg-light border-0 text-muted"> <i
                                        data-lucide="map-pin" style="width: 15px;"></i> </span> <select id="filtroRuta"
                                    class="form-select bg-light border-0 fs-7">
        ...
        </div> {{-- Columna Derecha: Panel Lateral (Detalles en Vivo) --}} <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-white py-3 border-0 d-flex justify-content-between align-items-center">
                    <h6 id="tituloPanelSalida" class="fw-bold mb-0">Detalle de salida</h6>
                </div>
                <div class="card-body p-3" id="panelSalidaContenido"> {{-- Carga inicial vacía --}} <p
                        class="text-muted text-center py-4">Selecciona una salida para ver la información en tiempo real.
                    </p>
                </div>
            </div>
        </div>
