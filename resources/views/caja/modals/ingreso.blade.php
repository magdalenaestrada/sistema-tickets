        ...
        <form id="form-ingreso" action="{{ route('caja.ingreso', $caja->id) }}" method="POST"
            ...
            <div class="modal-header border-0 pb-0">
                <div class="w-100 text-center">
                    <h3 class="mb-1 text-primary fw-light">Registrar ingreso</h3>
                </div>
            ...
            <div class="modal-body pt-2 px-4">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="metodo_pago_id" id="tipo_ingreso" class="form-select" required>
                            <option value="">Seleccione</option>
                    ...
                    {{-- SIMPLE --}}
                    <div class="col-12 ingreso-campo d-none" id="ingreso_monto_simple">
                    ...
                    {{-- MIXTO --}}
                    <div class="col-12 ingreso-campo d-none" id="ingreso_monto_efectivo">
                        <div class="row g-2 align-items-center">
                            <div class="col-md-5">
                                <div class="bg-light rounded p-3 fw-semibold">
                                    💵 Efectivo
                    ...
                    <div class="col-12 ingreso-campo d-none" id="ingreso_monto_digital">
                        <div class="row g-2 align-items-center">
                            <div class="col-md-5">
                                <div class="bg-light rounded p-3 fw-semibold">
                                    📲 Monto digital
                    ...
                    <div class="col-12 ingreso-campo d-none" id="ingreso_billetera">
                        <div class="row g-2 align-items-center">
                            <div class="col-md-5">
                                <div class="bg-light rounded p-3 fw-semibold">
                                    🏦 Billetera / digital
